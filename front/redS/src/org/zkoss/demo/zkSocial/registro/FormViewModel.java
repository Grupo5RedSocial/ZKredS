...
public class FormViewModel extends UserForm {
	...
	public void submit(@BindingParam("fx") Form fx) throws Exception {
		...
		String respuesta = ApacheHttpClientGet.POST("http://localhost:8080/Prueba/WsRed/addUser",usuario, request.getSession());
		if(!respuesta.equals("OK")){
	...
	public void cambiarPass(@BindingParam("fx") Form fx) throws Exception {
		...
		if (respuesta == 0){
			...
			String resp = ApacheHttpClientGet.POST("http://localhost:8080/Prueba/WsRed/changePass",usuario, request.getSession());
			if(!resp.equals("OK")){
	...
	// para cargar la imagen cuando se haga una publicacion
		...
		public void cambiar(@BindingParam("fx") Form fx) throws Exception {
		    ...
		    String respuesta =ApacheHttpClientGet.POST("http://localhost:8080/Prueba/WsRed/changePass",usuario, request.getSession());
			if(!respuesta.equals("OK")){
